...
function base16-harmonic-light -d "Harmonic16 Light"
  set color00 '#f7f9fb' # Base 00 - Black
  ...
  set color07 '#405c79' # Base 05 - White
  set color08 '#aabcce' # Base 03 - Bright Black
  ...
  set color15 '#0b1c2c' # Base 07 - Bright White
  set color16 '#bfbf56' # Base 09
  set color17 '#bf5656' # Base 0F
  set color18 '#e5ebf1' # Base 01
  set color19 '#cbd6e2' # Base 02
  set color20 '#627e99' # Base 04
  set color21 '#223b54' # Base 06
