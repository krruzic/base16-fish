...
function base16-solarized-light -d "Solarized Light"
  set -gx color00 '#fdf6e3' # Base 00 - Black
  ...
  set -gx color07 '#586e75' # Base 05 - White
  set -gx color08 '#839496' # Base 03 - Bright Black
  ...
  set -gx color15 '#002b36' # Base 07 - Bright White
  set -gx color16 '#cb4b16' # Base 09
  set -gx color17 '#d33682' # Base 0F
  set -gx color18 '#eee8d5' # Base 01
  set -gx color19 '#93a1a1' # Base 02
  set -gx color20 '#657b83' # Base 04
  set -gx color21 '#073642' # Base 06
