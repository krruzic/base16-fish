...
function base16-brushtrees-dark -d "Brush Trees Dark"
  set color00 '#485867' # Base 00 - Black
  ...
  set color07 '#B0C5C8' # Base 05 - White
  set color08 '#8299A1' # Base 03 - Bright Black
  ...
  set color15 '#E3EFEF' # Base 07 - Bright White
  set color16 '#d8bba2' # Base 09
  set color17 '#b39f9f' # Base 0F
  set color18 '#5A6D7A' # Base 01
  set color19 '#6D828E' # Base 02
  set color20 '#98AFB5' # Base 04
  set color21 '#C9DBDC' # Base 06
