...
function base16-chalk -d "Chalk"
  set color00 '#151515' # Base 00 - Black
  set color01 '#fb9fb1' # Base 08 - Red
  set color02 '#acc267' # Base 0B - Green
  set color03 '#ddb26f' # Base 0A - Yellow
  set color04 '#6fc2ef' # Base 0D - Blue
  set color05 '#e1a3ee' # Base 0E - Magenta
  set color06 '#12cfc0' # Base 0C - Cyan
  ...
  set color15 '#f5f5f5' # Base 07 - Bright White
  set color16 '#eda987' # Base 09
  set color17 '#deaf8f' # Base 0F
