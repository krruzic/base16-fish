...
function base16-atelier-heath-light -d "Atelier Heath Light"
  set color00 '#f7f3f7' # Base 00 - Black
  ...
  set color07 '#695d69' # Base 05 - White
  set color08 '#9e8f9e' # Base 03 - Bright Black
  ...
  set color15 '#1b181b' # Base 07 - Bright White
  set color16 '#a65926' # Base 09
  set color17 '#cc33cc' # Base 0F
  set color18 '#d8cad8' # Base 01
  set color19 '#ab9bab' # Base 02
  set color20 '#776977' # Base 04
  set color21 '#292329' # Base 06
