...
function base16-atelier-lakeside-light -d "Atelier Lakeside Light"
  set color00 '#ebf8ff' # Base 00 - Black
  ...
  set color07 '#516d7b' # Base 05 - White
  set color08 '#7195a8' # Base 03 - Bright Black
  ...
  set color15 '#161b1d' # Base 07 - Bright White
  set color16 '#935c25' # Base 09
  set color17 '#b72dd2' # Base 0F
  set color18 '#c1e4f6' # Base 01
  set color19 '#7ea2b4' # Base 02
  set color20 '#5a7b8c' # Base 04
  set color21 '#1f292e' # Base 06
