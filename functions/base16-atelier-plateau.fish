...
function base16-atelier-plateau -d "Atelier Plateau"
  set -gx color00 '#1b1818' # Base 00 - Black
  ...
  set -gx color07 '#8a8585' # Base 05 - White
  set -gx color08 '#655d5d' # Base 03 - Bright Black
  ...
  set -gx color15 '#f4ecec' # Base 07 - Bright White
  set -gx color16 '#b45a3c' # Base 09
  set -gx color17 '#bd5187' # Base 0F
  set -gx color18 '#292424' # Base 01
  set -gx color19 '#585050' # Base 02
  set -gx color20 '#7e7777' # Base 04
  set -gx color21 '#e7dfdf' # Base 06
