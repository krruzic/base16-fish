...
function set_colors
  ...
  if test -n "$ITERM_SESSION_ID"
    ...
    put_template_var 10 (hex_to_rgb $colorfg)
    if [ "$BASE16_SHELL_SET_BACKGROUND" != false ]
      put_template_var 11 (hex_to_rgb $colorbg)
  ...
  set -U fish_color_autosuggestion (hex_without_hash $color19)
  set -U fish_color_cancel -r
  set -U fish_color_command green #white
  set -U fish_color_comment (hex_without_hash $color19)
  ...
  set -U fish_color_search_match bryellow --background=(hex_without_hash $color19)
  set -U fish_color_selection white --bold --background=(hex_without_hash $color19)
