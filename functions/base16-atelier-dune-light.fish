...
function base16-atelier-dune-light -d "Atelier Dune Light"
  set color00 '#fefbec' # Base 00 - Black
  ...
  set color07 '#6e6b5e' # Base 05 - White
  set color08 '#999580' # Base 03 - Bright Black
  ...
  set color15 '#20201d' # Base 07 - Bright White
  set color16 '#b65611' # Base 09
  set color17 '#d43552' # Base 0F
  set color18 '#e8e4cf' # Base 01
  set color19 '#a6a28c' # Base 02
  set color20 '#7d7a68' # Base 04
  set color21 '#292824' # Base 06
