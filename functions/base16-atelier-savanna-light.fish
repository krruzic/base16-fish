...
function base16-atelier-savanna-light -d "Atelier Savanna Light"
  set -gx color00 '#ecf4ee' # Base 00 - Black
  ...
  set -gx color07 '#526057' # Base 05 - White
  set -gx color08 '#78877d' # Base 03 - Bright Black
  ...
  set -gx color15 '#171c19' # Base 07 - Bright White
  set -gx color16 '#9f713c' # Base 09
  set -gx color17 '#867469' # Base 0F
  set -gx color18 '#dfe7e2' # Base 01
  set -gx color19 '#87928a' # Base 02
  set -gx color20 '#5f6d64' # Base 04
  set -gx color21 '#232a25' # Base 06
