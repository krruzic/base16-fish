...
function base16-grayscale-light -d "Grayscale Light"
  set color00 '#f7f7f7' # Base 00 - Black
  ...
  set color07 '#464646' # Base 05 - White
  set color08 '#ababab' # Base 03 - Bright Black
  ...
  set color15 '#101010' # Base 07 - Bright White
  set color16 '#999999' # Base 09
  set color17 '#5e5e5e' # Base 0F
  set color18 '#e3e3e3' # Base 01
  set color19 '#b9b9b9' # Base 02
  set color20 '#525252' # Base 04
  set color21 '#252525' # Base 06
