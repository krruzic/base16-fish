...
function base16-atelier-sulphurpool -d "Atelier Sulphurpool"
  set -gx color00 '#202746' # Base 00 - Black
  ...
  set -gx color07 '#979db4' # Base 05 - White
  set -gx color08 '#6b7394' # Base 03 - Bright Black
  ...
  set -gx color15 '#f5f7ff' # Base 07 - Bright White
  set -gx color16 '#c76b29' # Base 09
  set -gx color17 '#9c637a' # Base 0F
  set -gx color18 '#293256' # Base 01
  set -gx color19 '#5e6687' # Base 02
  set -gx color20 '#898ea4' # Base 04
  set -gx color21 '#dfe2f1' # Base 06
