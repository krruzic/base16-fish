...
function base16-atelier-heath -d "Atelier Heath"
  set -gx color00 '#1b181b' # Base 00 - Black
  ...
  set -gx color07 '#ab9bab' # Base 05 - White
  set -gx color08 '#776977' # Base 03 - Bright Black
  ...
  set -gx color15 '#f7f3f7' # Base 07 - Bright White
  set -gx color16 '#a65926' # Base 09
  set -gx color17 '#cc33cc' # Base 0F
  set -gx color18 '#292329' # Base 01
  set -gx color19 '#695d69' # Base 02
  set -gx color20 '#9e8f9e' # Base 04
  set -gx color21 '#d8cad8' # Base 06
