...
function base16-brushtrees -d "Brush Trees"
  set -gx color00 '#E3EFEF' # Base 00 - Black
  ...
  set -gx color07 '#6D828E' # Base 05 - White
  set -gx color08 '#98AFB5' # Base 03 - Bright Black
  ...
  set -gx color15 '#485867' # Base 07 - Bright White
  set -gx color16 '#d8bba2' # Base 09
  set -gx color17 '#b39f9f' # Base 0F
  set -gx color18 '#C9DBDC' # Base 01
  set -gx color19 '#B0C5C8' # Base 02
  set -gx color20 '#8299A1' # Base 04
  set -gx color21 '#5A6D7A' # Base 06
