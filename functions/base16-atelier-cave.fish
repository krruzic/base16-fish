...
function base16-atelier-cave -d "Atelier Cave"
  set -gx color00 '#19171c' # Base 00 - Black
  ...
  set -gx color07 '#8b8792' # Base 05 - White
  set -gx color08 '#655f6d' # Base 03 - Bright Black
  ...
  set -gx color15 '#efecf4' # Base 07 - Bright White
  set -gx color16 '#aa573c' # Base 09
  set -gx color17 '#bf40bf' # Base 0F
  set -gx color18 '#26232a' # Base 01
  set -gx color19 '#585260' # Base 02
  set -gx color20 '#7e7887' # Base 04
  set -gx color21 '#e2dfe7' # Base 06
