...
function base16-atelier-seaside-light -d "Atelier Seaside Light"
  set color00 '#f4fbf4' # Base 00 - Black
  ...
  set color07 '#5e6e5e' # Base 05 - White
  set color08 '#809980' # Base 03 - Bright Black
  ...
  set color15 '#131513' # Base 07 - Bright White
  set color16 '#87711d' # Base 09
  set color17 '#e619c3' # Base 0F
  set color18 '#cfe8cf' # Base 01
  set color19 '#8ca68c' # Base 02
  set color20 '#687d68' # Base 04
  set color21 '#242924' # Base 06
