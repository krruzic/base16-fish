...
function base16-harmonic-dark -d "Harmonic16 Dark"
  set -gx color00 '#0b1c2c' # Base 00 - Black
  ...
  set -gx color07 '#cbd6e2' # Base 05 - White
  set -gx color08 '#627e99' # Base 03 - Bright Black
  ...
  set -gx color15 '#f7f9fb' # Base 07 - Bright White
  set -gx color16 '#bfbf56' # Base 09
  set -gx color17 '#bf5656' # Base 0F
  set -gx color18 '#223b54' # Base 01
  set -gx color19 '#405c79' # Base 02
  set -gx color20 '#aabcce' # Base 04
  set -gx color21 '#e5ebf1' # Base 06
