...
function base16-harmonic-dark -d "Harmonic16 Dark"
  set color00 '#0b1c2c' # Base 00 - Black
  set color01 '#bf8b56' # Base 08 - Red
  set color02 '#56bf8b' # Base 0B - Green
  set color03 '#8bbf56' # Base 0A - Yellow
  set color04 '#8b56bf' # Base 0D - Blue
  set color05 '#bf568b' # Base 0E - Magenta
  set color06 '#568bbf' # Base 0C - Cyan
  set color07 '#cbd6e2' # Base 05 - White
  set color08 '#627e99' # Base 03 - Bright Black
  ...
  set color15 '#f7f9fb' # Base 07 - Bright White
  set color16 '#bfbf56' # Base 09
  set color17 '#bf5656' # Base 0F
  set color18 '#223b54' # Base 01
  set color19 '#405c79' # Base 02
  set color20 '#aabcce' # Base 04
  set color21 '#e5ebf1' # Base 06
